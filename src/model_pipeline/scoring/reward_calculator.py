...
class RewardCalculator:
    ...
    def calculate_reward(self, card: Dict[str, Any], transaction: Dict[str, Any]) -> float:
        """
    ...
    def calculate_reward_with_credits(self, card: Dict[str, Any], transaction: Dict[str, Any]) -> float:
        """
    ...
    def is_welcome_bonus_eligible(self, card: Dict[str, Any], user_status: Dict[str, Any]) -> bool:
        """
    ...
    def _extract_reward_rate(self, card: Dict[str, Any], transaction: Dict[str, Any]) -> float:
        """
        ...
        if reward_rates is None or not isinstance(reward_rates, dict):
            logger.warning(f"Card {card.get('card_id')} missing reward_rates, using default")
            return self.default_reward_rate
        
        category = transaction.get('category', 'general')
        base_rate = float(reward_rates.get('universal_base_rate', self.default_reward_rate))
