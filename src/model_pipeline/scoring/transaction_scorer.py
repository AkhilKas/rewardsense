...
class TransactionScorer:
    ...
    def score_card(self, card: Dict[str, Any], transaction: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def score_portfolio(self, portfolio: List[Dict[str, Any]],
    ...
    def score_batch(self, portfolio: List[Dict[str, Any]],
        ...
        logger.info(f"Batch scored {len(transactions)} transactions against {len(portfolio)} cards")
        return results